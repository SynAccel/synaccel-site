export const meta = {
  ...
  date: "2025-12-10",
  readTime: "8 min read",
  tags: ["AI security", "Automation", "SOC", "Autonomous defense"],
  excerpt:
    "The industry moved from manual work to scripts, then to platforms. Now AI is accelerating the shift toward systems that understand, predict, and respond at machine speed.",
